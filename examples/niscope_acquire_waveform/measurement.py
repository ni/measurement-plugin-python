...
@measurement_service.configuration("vertical_coupling", nims.DataType.Enum, niscope.VerticalCoupling.DC.value, enum_type=niscope.VerticalCoupling)
...
@measurement_service.configuration("trigger_slope", nims.DataType.Enum, niscope.TriggerSlope.POSITIVE.value, enum_type=niscope.TriggerSlope)
@measurement_service.configuration("auto_trigger", nims.DataType.Boolean, False)
@measurement_service.configuration("trigger_coupling", nims.DataType.Enum, niscope.TriggerCoupling.DC.value, enum_type=niscope.TriggerCoupling)
