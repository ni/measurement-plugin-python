...
- Includes both a .measui (default) and LabVIEW .vi user interface. To change the
  example to use the LabVIEW .vi, simply switch the order of the `ui_file_paths`
  array in measurement.py
