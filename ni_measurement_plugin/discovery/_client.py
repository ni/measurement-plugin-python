...
from ni_measurement_plugin._internal.stubs.ni.measurementlink.discovery.v1 import (
    discovery_service_pb2,
    discovery_service_pb2_grpc,
)
from ni_measurement_plugin.discovery._support import _get_discovery_service_address
