...
class MeasureRequest(google.protobuf.message.Message):
    ...
    @property
    def inputs(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___DataValue]:
    ...
    def __init__(
        ...
        *,
        ...
        inputs: collections.abc.Iterable[global___DataValue] | None = ...,
    ) -> None: ...
    ...
    def ClearField(self, field_name: typing.Literal["configuration_parameters", b"configuration_parameters", "inputs", b"inputs", "pin_map_context", b"pin_map_context"]) -> None: ...
...
class MeasureResponse(google.protobuf.message.Message):
    ...
    @property
    def outputs(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___DataValue]:
        """Required. Specifies the list of values (data or data moniker) output from a single iteration or call of `Measure`."""

    def __init__(
        self,
        *,
        outputs: collections.abc.Iterable[global___DataValue] | None = ...,
    ) -> None: ...
...
class DataValue(google.protobuf.message.Message):
    ...
    @property
    def moniker(self) -> ni_datamonikers_v1_data_moniker_pb2.Moniker: ...
    def __init__(
        self,
        *,
        value: google.protobuf.any_pb2.Any | None = ...,
        moniker: ni_datamonikers_v1_data_moniker_pb2.Moniker | None = ...,
    ) -> None: ...
    def HasField(self, field_name: typing.Literal["data", b"data", "moniker", b"moniker", "value", b"value"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["data", b"data", "moniker", b"moniker", "value", b"value"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["data", b"data"]) -> typing.Literal["value", "moniker"] | None: ...
...
class MeasurementSignature(google.protobuf.message.Message):
    ...
    @property
    def inputs(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___DataValueMetadata]:
        """Required. Represents the type of data expected when reading from the input DataValues."""

    @property
    def outputs(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___DataValueMetadata]:
    ...
    def __init__(
        ...
        *,
        ...
        inputs: collections.abc.Iterable[global___DataValueMetadata] | None = ...,
        outputs: collections.abc.Iterable[global___DataValueMetadata] | None = ...,
    ) -> None: ...
    def HasField(self, field_name: typing.Literal["configuration_defaults", b"configuration_defaults"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["configuration_defaults", b"configuration_defaults", "configuration_parameters", b"configuration_parameters", "configuration_parameters_message_type", b"configuration_parameters_message_type", "inputs", b"inputs", "outputs", b"outputs"]) -> None: ...

global___MeasurementSignature = MeasurementSignature

@typing.final
class DataValueMetadata(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor
    ...
    def ClearField(self, field_name: typing.Literal["name", b"name", "type_url", b"type_url"]) -> None: ...

global___DataValueMetadata = DataValueMetadata
