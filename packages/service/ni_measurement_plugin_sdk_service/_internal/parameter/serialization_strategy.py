...
from ni_measurement_plugin_sdk_service._internal.parameter import _message
...
def _scalar_decoder(decoder: DecoderConstructor) -> PartialDecoderConstructor:
    ...
    def _unsupported_new_default(message: Optional[Message]) -> Any:
        raise NotImplementedError(
            "This function should not be called. Verify that you are using up-to-date and compatible versions of the ni-measurement-plugin-sdk-service and protobuf packages."
        )
