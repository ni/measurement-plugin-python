...
_INITIALIZATION_BEHAVIOR = {
    ...
    SessionInitializationBehavior.INITIALIZE_SERVER_SESSION_THEN_DETACH: niscope.SessionInitializationBehavior.INITIALIZE_SERVER_SESSION,
    SessionInitializationBehavior.ATTACH_TO_SERVER_SESSION_THEN_CLOSE: niscope.SessionInitializationBehavior.ATTACH_TO_SERVER_SESSION,
}
