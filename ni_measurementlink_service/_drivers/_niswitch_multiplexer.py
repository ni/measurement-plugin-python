...
class MultiplexerSessionConstructor:
    """Constructs sessions based on MultiplexerSessionInformation."""
    ...
    def __init__(
        ...
        """Initializes the multiplexer session constructor."""
    ...
    def __call__(self, session_info: MultiplexerSessionInformation) -> niswitch.Session:
