...
class _MeasurementClient:
    ...
    def __init__(self, service_class: str):
        ...
        self._configuration_metadata_by_id = {1: ParameterMetadata(display_name='Int In', type=3, repeated=False, default_value=50, annotations={}, message_type='')}
        self._output_metadata_by_id = {1: ParameterMetadata(display_name='Int out', type=9, repeated=False, default_value=0, annotations={}, message_type='')}
...
_client = _MeasurementClient("ni.examples.SampleMeasurement_Python")

def measure(
    int_in: int = 10
) -> Generator[Output, None, None]:
    """MeasurementLink example that performs a loopback measurement with various data types.
