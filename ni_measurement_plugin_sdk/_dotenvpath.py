...
def _get_caller_path() -> Optional[Path]:
    """Get the path of the module calling into ni_measurement_plugin_sdk, if possible."""
...
def _get_nims_path() -> Path:
    """Get the path of the ni_measurement_plugin_sdk package."""
    nims_module = sys.modules["ni_measurement_plugin_sdk"]
