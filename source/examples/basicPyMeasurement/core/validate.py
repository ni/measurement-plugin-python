...
def ValidateAnnotation(f):
    ...
    def check(*args, **kwargs):
        ...
        """
        argdict = defaults.copy() # this Dict Not having Non Default Data - Linked to fixing defaultss={}- Not used #todo
        ...
        for key, annotation in annotations.items():
            ...
            try:
                if callable(annotation) and not annotation(value):
                    if value != False: #workaround - If Value is False for bool -Skips Error - But Might also skip if Value is False for non-bools
