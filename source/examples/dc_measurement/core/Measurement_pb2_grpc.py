...
class MeasurementService(object):
    ...
    def GetMetadata(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/ni.measurements.v1.MeasurementService/GetMetadata',
    ...
    def Measure(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/ni.measurements.v1.MeasurementService/Measure',
