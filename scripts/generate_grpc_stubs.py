...
def remove_generated_files(stubs_path: pathlib.Path):
...
def fix_import_paths(stubs_path: pathlib.Path, stubs_namespace: str, proto_parent_namespace: str):
...
def add_init_files(stubs_path: pathlib.Path):
