...
Run `poetry run python scripts/generate_grpc_stubs.py`, this will generate all the required *.py file for the proto files listed above. The required `grpcio-tools` package is already added as a development dependency in pyproject.toml.
