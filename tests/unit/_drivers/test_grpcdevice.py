...
from ni_measurement_plugin_sdk._drivers._grpcdevice import (
    SERVICE_CLASS,
    get_grpc_device_server_location,
    get_insecure_grpc_device_server_channel,
)
from ni_measurement_plugin_sdk.discovery import ServiceLocation
...
def test___use_grpc_device_server_false___get_grpc_device_server_location___returns_empty_string(
    ...
    mocker.patch("ni_measurement_plugin_sdk._drivers._grpcdevice.USE_GRPC_DEVICE_SERVER", False)
...
def test___grpc_device_server_address_set___get_grpc_device_server_location___returns_configured_address(
    ...
    mocker.patch(
        "ni_measurement_plugin_sdk._drivers._grpcdevice.GRPC_DEVICE_SERVER_ADDRESS",
