...
from ni_measurement_plugin_sdk._configuration import MIDriverOptions, NISwitchOptions
...
def config(mocker: MockerFixture) -> Mock:
    ...
    return mocker.patch("ni_measurement_plugin_sdk._configuration._config")
