...
class Outputs(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["channel_lists", b"channel_lists", "pin_map_id", b"pin_map_id", "resource_names", b"resource_names", "session_names", b"session_names", "sites", b"sites"]) -> None: ...
