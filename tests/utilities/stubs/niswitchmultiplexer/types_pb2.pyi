...
class Outputs(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["connected_channels", b"connected_channels", "multiplexer_resource_names", b"multiplexer_resource_names", "multiplexer_routes", b"multiplexer_routes", "multiplexer_session_names", b"multiplexer_session_names"]) -> None: ...
